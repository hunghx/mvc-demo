                    ...
                    <div class="col-6 text-end">
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a class="text-mueditModald" href="#" target="_blank">Support</a>
                            </li>
                            <li class="list-inline-item">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="id" id="category_id" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Category Name</label>
                        <input type="text" class="form-control" name="name" id="category_name_edit">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Descriptions</label>
